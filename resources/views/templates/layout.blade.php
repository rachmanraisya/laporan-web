...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown user-menu"> 
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> 
                            <img src="{{ asset('assets') }}/img/user8-128x128.jpg" class="user-image rounded-circle shadow" alt="User Image"> 
                            <span class="d-none d-md-inline">Raisya Rachman</span> 
                        </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> 
                            <!--begin::User Image-->
                            <li class="user-header text-bg-primary"> 
                                <img src="user8-128x128.jpg" class="rounded-circle shadow" alt="User Image">
                                <p>
                                    Raisya Rachman - Web Developer
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> 
            ...
            <div class="sidebar-brand"> 
                ...
                <a href="./index.html" class="brand-link"> 
                    ...
                    <!--end::Brand Image--> 
                    <!--begin::Brand Text--> 
                    <span class="brand-text fw-light">peduli</span> 
                    <!--end::Brand Text--> 
                </a> 
                <!--end::Brand Link--> 
    ...
    <div class="sidebar-brand">
        ...
        <a href="{{ url('/') }}" class="brand-link">
            <!--begin::Brand Image-->
            <img src="{{ asset('assets') }}/img/AdminLTEFullLogo.png" alt="AdminLTE Logo" class="brand-image opacity-75 shadow">
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <!--end::Brand Text-->
        </a>
    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                <li class="nav-item menu-open">
                    <a href="{{ url('perjalanan') }}" class="nav-link active">
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                <li class="nav-item menu-open">
                    <a href="{{ url('penduduk') }}" class="nav-link active">
